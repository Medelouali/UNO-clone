...
class Card(Object):
    def __init__(self, number=None, color=None, type="Normal", coordinates=[1, 1], dimensions=[100, 100], icon=getPath("images", "logo.png"), callback=None):
        super().__init__(coordinates, dimensions, icon, callback)
        self.number = number
        self.color=color
        self.type=type
        self.icon = icon
